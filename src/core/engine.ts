...
export interface BrainEngine {
  ...
  // Raw SQL execution (engine-agnostic)
  ...
  // Files
  listFiles(pageSlug?: string): Promise<any[]>;
  uploadFile(file: { page_slug?: string; filename: string; storage_path: string; mime_type?: string; size_bytes?: number; content_hash: string; metadata?: Record<string, any> }): Promise<{ id: number }>;
  getFileUrl(storagePath: string): Promise<{ storage_path: string; filename: string; mime_type?: string } | null>;
}

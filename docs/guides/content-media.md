...
4. **Cross-references make media pages alive.** A YouTube page without back-links to the people and companies mentioned is a dead archive. Every mentioned entity gets a link and a page update.
...
3. Pick a person mentioned in the video. Run `gbrain get <person_slug>`. Confirm their page has been updated with a reference to the video with specific context.

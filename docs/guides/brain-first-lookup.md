...
With this: the agent pulls your compiled truth, recent activity, and
...
4. **Load compiled truth.** The compiled truth gives you the
   state of play in 30 seconds. Recent updates show what changed lately.
   Together = full context.

    ...
    for attendee in meeting.attendees:
        ...
        if results:
            ...
            briefing[attendee] = {
                ...
                "last_interaction": page.last_updated,     # most recent
...
3. After clearing an inbox, check 2 sender brain pages with `gbrain get <slug>`. Confirm pages were updated with information from the emails.

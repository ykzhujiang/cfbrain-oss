...
- **pages** — slug (unique), type, title, compiled_truth, frontmatter (JSONB)
- **content_chunks** — pgvector 1536-dim embedding, chunk_source (compiled_truth)
...
Full-text search uses weighted tsvector: title (A), compiled_truth (B).

...
- Trigger-based search_vector on pages
...
**Migration:** `gbrain migrate --to supabase` exports everything (pages, chunks, embeddings, links, tags) and imports into Supabase. `gbrain migrate --to pglite` goes the other direction. Bidirectional, lossless.
